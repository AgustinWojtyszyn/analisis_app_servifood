...
export default function PortalActionCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="group relative flex min-h-[168px] w-full cursor-pointer flex-col justify-between overflow-hidden rounded-xl border border-slate-300 bg-white p-5 text-left shadow-[0_3px_10px_rgba(15,23,42,0.07)] transition-all duration-150 hover:-translate-y-0.5 hover:border-blue-300 hover:shadow-[0_8px_20px_rgba(37,99,235,0.12)] focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
    ...
    >
      ...
      <div className="flex items-start justify-between gap-4 pl-1">
        ...
        <span className="grid h-8 w-8 shrink-0 place-items-center rounded-full border border-slate-200 bg-slate-50 text-slate-400 transition-all group-hover:border-blue-200 group-hover:bg-blue-50 group-hover:text-blue-600">
